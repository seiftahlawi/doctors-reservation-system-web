...
class ReproductiveDoctor extends Component {
...
ishome:true
  ...
  componentDidUpdate(){
    ...
    render(){
      ...
      const Doctors = this.state.info.map((doctors,index)=>{if(doctors.specialty=='Reproductive doctor') {return <Card doctor={doctors} key={index} />}})
...
export default ReproductiveDoctor