...
class PlasticSurgeries extends Component {
...
ishome:true
  ...
  componentDidUpdate(){
    ...
    render(){
      ...
      const Doctors = this.state.info.map((doctors,index)=>{if(doctors.specialty=='Plastic surgeries') {return <Card doctor={doctors} key={index} />}})
...
export default PlasticSurgeries