...
class GeneralMedicine extends Component {
...
ishome:true
  ...
  componentDidUpdate(){
    ...
    render(){
      ...
      const Doctors = this.state.info.map((doctors,index)=>{if(doctors.specialty=='General Medicine') {return <Card doctor={doctors} key={index} />}})
